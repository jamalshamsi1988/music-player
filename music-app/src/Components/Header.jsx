import logo from "./../assets/img/download-sound.png";
import musicImg from "./../assets/img/music-img.jpg";
    ...
    <header>
      <article className="container h-100">
        <article className="h-100 d-flex align-items-center">
          <section className="music-cover " style={{bacgroundImage:`url(${musicImg})`}}>
          ...
          <section className="music-description flex-grow-1">
            ...
            <section className="music-range">
              <span>00:35</span> <span>03:35</span>
              <input type="range" />
            </section>
